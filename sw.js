...
const SHELL_FILES = [
  '/dominion-forger/',
  '/dominion-forger/index.html',
  '/dominion-forger/css/style.css',
  '/dominion-forger/js/router.js',
  '/dominion-forger/js/pages/home.js',
  '/dominion-forger/js/pages/randomizer.js',
  '/dominion-forger/js/pages/browse.js',
  '/dominion-forger/js/pages/card.js',
  '/dominion-forger/js/pages/expansions.js',
  '/dominion-forger/js/pages/kingdoms.js',
  '/dominion-forger/js/pages/statistics.js',
  '/dominion-forger/js/pages/about.js',
  '/dominion-forger/manifest.json',
  '/dominion-forger/images/website/DFlogo.jpg',
  '/dominion-forger/images/website/DFlogo-192.jpg',
  '/dominion-forger/images/website/DFlogo-512.jpg',
];
...
const DATA_FILES = [
  ...
  'Rising Sun',
  'Seaside',
].map(name => `/dominion-forger/parsed_text/${encodeURIComponent(name)}.json`);
...
self.addEventListener('fetch', e => {
  ...
  if (path.includes('/dominion-forger/images/') && !path.includes('/images/website/')) {
    e.respondWith((async () => {
  ...
  e.respondWith((async () => {
    ...
    try {
      ...
      if (e.request.mode === 'navigate') {
        return shellCache.match('/dominion-forger/index.html');
      }
      return new Response('', { status: 404 });
    }
  })());
